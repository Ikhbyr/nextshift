  ...
  <nav class="sp-global-nav">
    <div class="sp-global-nav-head">
      ...
      <ul class="mypage-menu">
        <li><a href="login.php" class="link_sub">ログイン</a></li>
  ...
  <!-- FOOTERが入ります -->
    ...
    <nav class="footer-nav">
      <ul>
        ...
        <li><a href="../faq/faq.php">よくある質問</a></li>
        <li><a href="inquiry_entry.php?command=new">お問い合わせ</a></li>
      </ul>
    </nav>
    <!--osaki変更ここから-->
    <div class="row">
    ...
    <div class="footer-credit">
      ...
      <p><a href="inquiry_entry.php?command=new">お問い合わせ</a>はこちら</p>
...
<!-- Mirrored from nextshiftfund.jp/investortop/login.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Mar 2020 11:14:38 GMT -->
</html>
