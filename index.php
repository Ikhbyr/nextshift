...
<!-- Mirrored from nextshiftfund.jp/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Mar 2020 11:13:56 GMT -->
    ...
    <div class="contents templates-fund in-page-link">
      ...
      <div class="ui stackable centered" id="top-latest-fund-list">
        <div class="sixteen wide column">
          ...
          $key = "SELECT * FROM funds ";
          $kkk=$conn->query($key);
          $count = mysqli_num_rows($kkk);
          if ($count > 0 ) {
            // code...
            while($row=mysqli_fetch_assoc($kkk)){
              $errors = '. $row["title"].';
              echo "<li>";
               echo "<div class='fd-wrapper'>";
                echo "<div class='status keep-on'> 募集中";
                 echo "</div>";
                ...
                echo "<div class='box-r'>";
                  ...
                  echo "<table class='tbl-gsp01'>";
                    echo "<thead>";
                    echo "  <tr>";
                    echo "    <th class='w30' >目標利回り（年率）</th>";
                    echo "    <th class='w30' >運用期間</th>";
                    echo "    <th class='w20' >分配</th>";
                    echo "    <th class='w20' >最低投資金額</th>";
                    echo "  </tr>";
                    echo "</thead>";
                    echo "<tbody>";
                    echo "  <tr class='last'>";
                    echo "    <td class='w30' data-title='目標利回り（年率）' ><span>".$row['profitRate']."％</span></td>";
                    echo "    <td class='w30' data-title='運用期間' ><span>".$row['duringOperation']."年</span></td>";
                    echo "    <td class='w20' data-title='分配' ><span>".$row['Distribution']."</span></td>";
                    echo "    <td class='w20' data-title='最低投資金額' ><span>¥".$row['investmentAmount']."</span></td>";
                    echo "  </tr>";
                  echo "  </tbody>";
                  echo "</table>";

                echo "    <p class='fd-time'>残り募集期間<span>16日  3:46</span></p>";
              echo "    <div class='fd-btn-light-blue-w'><a href='investment/fund_detail/35/index.php'><span class='fd-arrow'>ファンドの詳細へ</span></a></div>";
              echo "  </div>";
              echo "  </div>";
              echo "</li>";
            };
...
<!-- Mirrored from nextshiftfund.jp/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Mar 2020 11:14:20 GMT -->
</html>
